...
fileID2 = fopen('el_energy_gpu_order1_3d.txt');

fileID3 = fopen('err_mass_order1_3d.txt');
fileID4 = fopen('err_mass_gpu_order1_3d.txt');

fileID5 = fopen('err_energy_order1_3d.txt');
fileID6 = fopen('err_energy_gpu_order1_3d.txt');
...
fileID2 = fopen('el_energy_gpu_order2_3d.txt');

fileID3 = fopen('err_mass_order2_3d.txt');
fileID4 = fopen('err_mass_gpu_order2_3d.txt');

fileID5 = fopen('err_energy_order2_3d.txt');
fileID6 = fopen('err_energy_gpu_order2_3d.txt');
